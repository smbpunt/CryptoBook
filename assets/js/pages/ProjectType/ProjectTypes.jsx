    ...
    return (
        <div className="container">
            <div className="d-flex justify-content-between align-items-center mb-3">
                <h1>Liste des types de projet</h1>
                <Link to="/project_types/new" className="btn btn-primary">Creer</Link>
            </div>
                            ...
                            <tr key={blockchain.id}>
                                ...
                                <td className="text-end">
                                    <div className="btn-group" role="group">
                                        <Link to={"/project_types/" + blockchain.id} className="btn btn-primary btn-sm">Modifier</Link>
